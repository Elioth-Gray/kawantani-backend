...
const articlesCategoryService_1 = require("../services/articlesCategoryService");
const getCategory = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const result = yield (0, articlesCategoryService_1.getAllCategory)();
        res.status(200).json({
            success: true,
...
const getCategoryId = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const result = yield (0, articlesCategoryService_1.getCategoryById)(numberId);
        res.status(200).json({
            success: true,
